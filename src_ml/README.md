...
There is a [github repo](https://github.com/crate/cratedb-explore/tree/main/src_ml) in [CrateDB explore](https://github.com/crate/cratedb-explore/tree/main/src_ml)  that 
allows you to do the following:

Starting from 500,000 real sensor readings across 500 devices, the [ML guide](https://github.com/crate/cratedb-explore/blob/main/src_ml/ML_GUIDE.md) walks you end-to-end from a JSON file to a live service backed by CrateDB:
