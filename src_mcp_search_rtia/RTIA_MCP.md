...
- A CrateDB cluster with the `rtia` schema loaded (`sql/rtia_schema_create.sql`),
...
Save the following as [`rtia_mcp.py`](https://github.com/crate/cratedb-explore/blob/main/src_mcp_search_rtia/rtia_mcp.py).
