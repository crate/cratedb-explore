...
`rtia.iot_data` (see sql/rtia_schema_create.sql) instead expects Telegraf's
...
Usage:
    python convert_flat_to_telegraf.py --input  data/iot_demo_dataset.json.gz \
                                       --output data/iot_demo_dataset.telegraf.json.gz
"""
