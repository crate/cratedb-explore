...
See its [`README.md`](sda/src/src_mcp_search_german_weather/README.md) — a draft cratedb.com walkthrough — for install, configuration, and how to register it with an assistant.
