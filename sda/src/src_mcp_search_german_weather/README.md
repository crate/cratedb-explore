...
Save the following as [`german_weather_mcp.py`](https://github.com/crate/cratedb-explore/blob/main/sda/src/src_mcp_search_german_weather/german_weather_mcp.py).
...
Before wiring the server into an assistant, you can call its tool by hand with
