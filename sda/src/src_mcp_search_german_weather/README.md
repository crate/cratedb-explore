...
```bash
claude mcp add german-weather -- python /abs/path/to/sda/src/src_mcp_search_german_weather/german_weather_mcp.py
```
...
```json
{
  "mcpServers": {
    "german-weather": {
      "command": "python",
      "args": ["/abs/path/to/sda/src/src_mcp_search_german_weather/german_weather_mcp.py"]
    }
  }
}
```
